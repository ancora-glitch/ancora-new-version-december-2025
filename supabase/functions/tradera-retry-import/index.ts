...
// - Picks up pending retry jobs from tradera_retry_jobs
// - Re-attempts GetItem via tradera-item edge function
// - On success: creates AIS draft item with HD images
// - On rate limit: reschedules with exponential backoff
// - INVARIANT: Never overwrite existing images, never downgrade quality
// ========================================

const MAX_ATTEMPTS = 8;
const BASE_BACKOFF_MS = 30 * 60 * 1000; // 30 minutes base
