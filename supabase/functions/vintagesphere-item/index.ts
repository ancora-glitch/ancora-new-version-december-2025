/**
 * VintageSphere Item — fetches a single product via Shopify JSON API
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.info(`[VintageSphereItem] Fetching: ${url}`);
    ...
    console.info("[VintageSphereItem]", {
      handle: product.handle,
    ...
    console.error("[VintageSphereItem] Error:", err.message);
    return new Response(
