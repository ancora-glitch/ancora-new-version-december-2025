  ...
  return <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 pt-24 md:pt-32">
        ...
        <section ref={(el) => sectionsRef.current[1] = el} className="fade-section md:px-12 lg:px-24 md:py-4 px-[60px] py-[8px]">
          <div className="max-w-[700px] mx-auto">
            <p className="article-intro">Ancora exists for the everyday style seekers and the hardcore fashion hunters — for anyone who wants to create a circular wardrobe.</p>
          </div>
        </section>
