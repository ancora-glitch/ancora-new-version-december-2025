      ...
      <main className="pt-16">
        ...
        <section className="px-4 md:px-8 lg:px-12 bg-primary pt-20 md:pt-20 lg:pt-20 pb-20 md:pb-28 lg:pb-32">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-5 md:gap-7 lg:gap-8 max-w-7xl mx-auto">
            {storiesLoading ? <p className="col-span-full text-center text-primary-foreground/70">Loading stories...</p> : mergedStories.length > 0 ? mergedStories.map(story => <GuideCard key={story.id} image={story.image || ""} title={story.title} href={story.href} focalPoint={story.focalPoint} external={story.external} />) : <p className="col-span-full text-center text-primary-foreground/70">No stories available</p>}
          </div>
        </section>
