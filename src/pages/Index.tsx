  ...
  return <div className="min-h-screen bg-background">
      ...
      <main className="pt-16">
        ...
        <section className="relative w-full h-[40vh] min-h-[300px]">
          <img alt="Woman in floral dress in formal garden" fetchPriority="high" width={1920} height={1280} className="absolute inset-0 w-full h-full object-cover [object-position:center_10%] md:[object-position:center_30%]" src={heroImage} />
