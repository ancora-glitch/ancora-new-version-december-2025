  ...
  return <div className="min-h-screen bg-background">
      ...
      <main className="pt-16">
        ...
        <section className="relative w-full h-[40vh] min-h-[300px]">
          <img alt="Woman in vintage blazer and jeans on sunlit street" fetchPriority="high" width={1920} height={1080} className="absolute inset-0 w-full h-full object-cover [object-position:center_25%]" src={heroImage} />
        ...
        <section className="px-4 md:px-8 lg:px-12 md:py-28 bg-secondary/40 py-[60px] pt-[60px] lg:py-[6px]">
