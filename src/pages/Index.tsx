  ...
  return <div className="min-h-screen bg-background">
      ...
      <main className="pt-16">
        ...
        <section className="relative w-full h-[40vh] min-h-[300px]">
          <img alt="Woman in sunglasses sitting on stadium bleachers" fetchPriority="high" width={1280} height={1920} className="absolute inset-0 w-full h-full object-cover [object-position:55%_30%] md:[object-position:55%_12%]" src={heroImage} />
