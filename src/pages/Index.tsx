...
import heroAsset from "@/assets/hero-portrait.jpg.asset.json";
  ...
  return <div className="min-h-screen bg-background">
      ...
      <main className="pt-16">
        ...
        <section className="relative w-full h-[40vh] min-h-[300px]">
          <img alt="Woman in a green striped dress leaning against a wall" fetchPriority="high" width={1280} height={1920} className="absolute inset-0 w-full h-full object-cover [object-position:55%_45%] md:[object-position:55%_55%]" src={heroImage} />
