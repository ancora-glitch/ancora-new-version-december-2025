    ...
    try {
      for (const itemId of selectedItems) {
        ...
        const importInput: any = {
          ...
          brand: tx.brand_en || parsed.brand_text || detail?.brand || "Unknown",
          size: tx.size_en || parsed.size_text || null,
          color: parsed.color_text || null,
          material: tx.material_en || parsed.material_text || null,
          condition: tx.condition_en || parsed.condition_text || item.conditionText || item.condition,
