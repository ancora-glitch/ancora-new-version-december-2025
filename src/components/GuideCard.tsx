...
export const GuideCard = ({ image, title, onGoToGuide }: GuideCardProps) => {
  return (
    <div className="group">
      ...
      <button
        onClick={onGoToGuide}
        className="w-full py-3.5 bg-card text-foreground text-xs tracking-widest uppercase hover:bg-secondary transition-colors duration-200 border border-border/30"
      >
        Go to guide
      </button>
    </div>
